if( typeof window.$c === "undefined")
    (function () {
        function getCookie(cookieName = null) {
            if (cookieName === null) {
                throw new Error("You have not entered a cookieName!");
            }
        ...
        function setCookie(cookieName, cookieValue, expiryDate = null) {
            if (typeof cookieName !== "string") {
                throw new Error("You should pass a string value for the cookieName!");
            }
            if (cookieName.length === 0) {
                throw new Error("You should not pass an empty string for a cookieName!");
            }
            if (expiryDate === null) {
            ...
            if (!(expiryDate instanceof Date) || isNaN(expiryDate.getTime())) {
                throw new TypeError("You should pass a date object!");
            }
        ...
        function deleteCookie(cookieName) {
            if (!hasCookie(cookieName)) {
                throw new Error("You dont have the cookie: " + cookieName + " in your cookies!");
            }
        ...
        function noConflict() {
            if (window.$c === this) {
                window.$c = oldVariable;
            }
        }
        var oldVariable = window.$c;
        window.$c = {
            get: getCookie,
            set: setCookie,
            delete: deleteCookie,
